...
describe('Fixnum#wordify') do
  ...
  it('takes a number above 20 (below 30) and returns the word twenty and the ones digit') do
    expect(021.wordify_lookup()).to(eq("twenty one"))
  end
 #
 ...
 #  end
 #
 #  it("takes a complex number over 1000 and returns the number") do
 #   expect(123456.wordify()).to(eq("one hundred twenty three thousand four hundred fifty six"))
 # end
